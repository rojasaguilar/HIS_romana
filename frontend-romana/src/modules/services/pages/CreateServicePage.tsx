...
export const CreateServicePage = () => {
  ...
  const activeSpecialities = specialities?.filter((spec) => spec.isActive);
      ...
      <div className="flex flex-col gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Define el nombre, costos y modalidades de las consultas.
          </p>
        </div>
      </div>
            ...
            <div className="md:col-span-2">
              ...
              <div className="relative">
                ...
                >
                  ...
                  {activeSpecialities?.map((speciality) => (
            ...
            <div className="md:col-span-2">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  const isSelected = modalities.includes(
                    item.id as ServiceModality,
                  );
                  return (
                    <div
                      key={item.id}
                      onClick={() =>
                        handleModalityChange(item.id as ServiceModality)
                      }
