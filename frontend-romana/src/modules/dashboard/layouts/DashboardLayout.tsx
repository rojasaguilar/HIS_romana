    ...
    <div className="flex min-h-screen bg-gray-50/50">
      ...
      <aside className="w-64 bg-white border-r border-gray-200 flex flex-col fixed h-screen z-20">
        ...
        <div className="p-6 flex items-center gap-3 border-b border-gray-100">
          ...
          <div>
            <h2 className="text-lg font-bold text-gray-900 leading-none">Romana</h2>
            <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-1">Gestión Clínica</p>
          </div>
        </div>
